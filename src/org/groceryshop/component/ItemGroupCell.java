 ...
 */
public class ItemGroupCell extends TableCell<StoreItem, String> {
    private TextField item;
    private TableView<StoreItem> datatable;
    private ItemController controller;

    public ItemGroupCell(TableView<StoreItem> datatable, ItemController controller) {
